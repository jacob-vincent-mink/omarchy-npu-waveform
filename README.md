...
The widget samples `npu_busy_time_us` once per second and converts the delta to utilization. Activity grows symmetrically from a black idle centerline using your current Omarchy accent color.
